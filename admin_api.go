...
func (bind *AdminApi[T]) getChromeCookieJar(urlParse *url.URL) *cookiejar.Jar {
...
func (bind *AdminApi[T]) get(urlStr string, params map[string]string) (*http.Response, error) {
...
func (bind *AdminApi[T]) post(urlStr string, params map[string]interface{}) (*http.Response, error) {
	formData := url.Values{}
	for i, v := range params {
		switch v := v.(type) {
		case []string:
...
func (bind *AdminApi[T]) toRet(response *http.Response) (*AdminApiRet, error) {
...
*/
func (bind *AdminApi[T]) CreateDevice(deviceId string, accessCode string) (*AdminApiRet, error) {
...
@param deviceId 设备号
*/
func (bind *AdminApi[T]) UpDeviceStatus(deviceId string) (*AdminApiRet, error) {
	params := map[string]interface{}{
		"ids":    deviceId,
		"params": "status=2",
	}
...
@param name 点位名称
*/
func (bind *AdminApi[T]) CreateLoc(name string) (*AdminApiRet, error) {
	params := map[string]interface{}{
...
func (bind *AdminApi[T]) GetLocList(filter string) (*AdminApiRet, error) {
...
func (bind *AdminApi[T]) DelLoc(id string) (*AdminApiRet, error) {
	params := map[string]interface{}{
		"ids":    id,
		"action": "del",
	}
